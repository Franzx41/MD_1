...
class Model:
    ...
    def train_test(self, average='binary'):
        ...
        self.report(y_train_pred, y_test_pred, average=average)
        
    def report(self, y_train_pred, y_test_pred, average='binary'):
        print("Train:")
        print("F1 Score:", f1_score(self.y_train, y_train_pred, average=average))
        print()
        print("Test:")
        print("F1 Score:", f1_score(self.y_test, y_test_pred, average=average))
        if average == 'binary':
